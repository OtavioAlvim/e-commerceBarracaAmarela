...
<body>
    ...
    <div class="container" id="pedidos">
        <p>DETALHES DO PEDIDO #<?php echo $id_pedido ?></p>
        <hr>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                foreach ($produto as $produto) { ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo number_format($produto['QTDE'],2,',')?></td>
                        <td class="text-center">R$: <?php echo number_format($produto['TOT_ITEM'],2,',')?></td>
                    </tr>
                <?php }
                ?>
