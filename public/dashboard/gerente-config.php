    ...
    <div class="container">
        ...
        <form class="row g-3">
            <div class="col-12 text-end">
                ...
                <a type="submit" class="btn btn-dark" href="./gerente.php">CANCELAR</a>
            </div>
            <div class="col-md-4">
                <label for="inputEmail4" class="form-label">CAMINHO DO BANCO DE DADOS</label>
                <input type="text" class="form-control" id="inputEmail4">
            </div>
            <div class="col-4">
                <label for="inputAddress2" class="form-label">USUARIO DO BANCO</label>
                <input type="text" class="form-control" id="inputAddress2">
            </div>
            <div class="col-md-4">
                <label for="inputPassword4" class="form-label">SENHA DO BANCO</label>
                <input type="text" class="form-control" id="inputPassword4">
            </div>
            <div class="col-4">
                <label for="inputAddress" class="form-label">NOME DO BANCO</label>
                <input type="text" class="form-control" id="inputAddress">
            </div>

            <div class="col-md-2">
                <label for="inputCity" class="form-label">ID EMPRESA</label>
                <input type="text" class="form-control" id="inputCity">
            </div>
            <div class="col-md-2">
                <label for="inputZip" class="form-label">ID VENDEDOR</label>
