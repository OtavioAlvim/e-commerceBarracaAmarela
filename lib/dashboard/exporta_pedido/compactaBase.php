...
$caminho = substr($Spath, 0, -12);

$diretorio_completo = $caminho . DIRECTORY_SEPARATOR . "DB" .DIRECTORY_SEPARATOR. $_SESSION['cnpj'] .DIRECTORY_SEPARATOR. "FTP\DB-EXPORTACAO" .DIRECTORY_SEPARATOR. $nome_arquivo;
